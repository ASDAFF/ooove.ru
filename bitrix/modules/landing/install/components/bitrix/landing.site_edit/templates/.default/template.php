									...
									?>
										...
										<?elseif ($domainCode == 'own'):?>
											...
											<div class="landing-alert landing-alert-info">
												...
												<table class="landing-alert-table" border="1">
													<tr class="landing-alert-table-header">
														<td><?= Loc::getMessage('LANDING_TPL_DOMAIN_OWN_DOMAIN_DNS_1');?></td>
														<td><?= Loc::getMessage('LANDING_TPL_DOMAIN_OWN_DOMAIN_DNS_2');?></td>
														<td><?= Loc::getMessage('LANDING_TPL_DOMAIN_OWN_DOMAIN_DNS_3');?></td>
													</tr>
													<tr>
												...
												<p class="landing-alert-paragraph">
													<a href="<?= $helpUrl;?>" target="_blank"><?= Loc::getMessage('LANDING_TPL_DOMAIN_OWN_DOMAIN_HELP');?></a>
												</p>
												<?endif;?>
											</div>
