...
<form method="POST" action="?action=save&lang=<?echo LANGUAGE_ID?>&<?=$tabControl->ActiveTabParam()?>" enctype="multipart/form-data" name="editform">
<?=bitrix_sessid_post()?>
	...
	<table class="adm-detail-content-table edit-table">
		<tr>
			<td class="adm-detail-content-cell-l">
				<label><?=GetMessage("LABEL_TITLE_OG_FIELDS");?>:</label>
			</td>
			<td width="60%" class="adm-detail-content-cell-r">
                <table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_og">
                    <tbody>
                        <? foreach ($ogFields as $key=>$field):
                            ...
                            <tr>
                                <td>
                                    <label>og:</label>
                                    <input name="FIELDS[og][n<?=$key?>]" value="<?=$field?>" size="30" type="text"><br>
                                </td>
                            </tr>
                        <? endforeach; ?>
                        <tr>
                            <td>
                                <label>og:</label>
                                <input name="FIELDS[og][n<?=count($ogFields)?>]" value="" size="30" type="text"><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <label><?=GetMessage("LABEL_CACHE_TIME_FIELDS");?>:</label>
            </td>
            <td width="60%" class="adm-detail-content-cell-r">
                <table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_fields_settings">
                    <tbody>
                        <tr>
                            <td>
                                <input type="text" name="OGSETTINGS[CACHE_TIME]" value="<?= $settingFields['CACHE_TIME']?>" required min="100">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <label><?=GetMessage("LABEL_TITLE_OG_PAGE_EXCLUDED");?>:</label>
            </td>
            <td width="60%" class="adm-detail-content-cell-r">
                <table class="nopadding" cellpadding="0" cellspacing="0" border="0" width="100%" id="d2f_page_excluded_og">
                    <tbody>
                    <? foreach ($excludedPages as $key=>$page):
                        ...
                        <tr>
                            <td>
                                ...
                                <input name="EXCLUDE_PAGE[n<?=$key?>]" value="<?=$page?>" size="30" type="text">
                            </td>
                        </tr>
                    <? endforeach; ?>
                    <tr>
                        <td>
                            <label><?=$serverUrl?></label>
                            <input name="EXCLUDE_PAGE[n<?=count($excludedPages)?>]" value="" size="30" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <label for="ADDTAB_ELEMENT"><?=Loc::getMessage('LABEL_SETTING_ADD_TAB_ELEMENT')?></label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="ADDTAB_SECTION"><?=Loc::getMessage('LABEL_SETTING_ADD_TAB_SECTION')?></label>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td width="60%" class="adm-detail-content-cell-r" colspan="">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    <tbody>
                        <tr>
                            <td>
                                <input type="checkbox" id="ADDTAB_ELEMENT" name="ADDTAB_ELEMENT" value="Y" <?=$enableTabElement?'checked="checked"':''?>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" id="ADDTAB_SECTION" name="ADDTAB_SECTION" value="Y" <?=$enableTabSection?'checked="checked"':''?>>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tr>
                        <td>
                            <div class="sort_container">
                                ...
                                <input type="hidden" value="<?=implode(',',$arSortable)?>" id="sortableOpenGraph" name="sortableOpenGraph">
                            </div>
                            <br>
                            <?= BeginNote();?>
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <label for="ADDTAB_ELEMENT"><?=Loc::getMessage('LABEL_SETTING_ADD_DEFAULT_IMAGE')?></label>
            </td>
            <td width="60%" class="adm-detail-content-cell-r" colspan="">
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <label for="LABEL_SETTING_OG_RESIZE_ENABLE"><?=Loc::getMessage('LABEL_SETTING_OG_RESIZE_ENABLE')?></label>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td width="60%" class="adm-detail-content-cell-r" colspan="">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" id="LABEL_SETTING_OG_RESIZE_ENABLE" name="OG_SETTINGS_RESIZE[ENABLE]" value="Y" <?=($arSettingResize['ENABLE']=='Y')?'checked':''?>>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <tr>
            <td class="adm-detail-content-cell-l">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <label for="LABEL_SETTING_OG_RESIZE_WIDTH"><?=Loc::getMessage('LABEL_SETTING_OG_RESIZE_WIDTH')?></label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="LABEL_SETTING_OG_RESIZE_HEIGHT"><?=Loc::getMessage('LABEL_SETTING_OG_RESIZE_HEIGHT')?></label>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td width="60%" class="adm-detail-content-cell-r" colspan="">
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <input type="text" id="LABEL_SETTING_OG_RESIZE_WIDTH" name="OG_SETTINGS_RESIZE[WIDTH]" value="<?=isset($arSettingResize['WIDTH'])?$arSettingResize['WIDTH']:''?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" id="LABEL_SETTING_OG_RESIZE_HEIGHT" name="OG_SETTINGS_RESIZE[HEIGHT]" value="<?=isset($arSettingResize['HEIGHT'])?$arSettingResize['HEIGHT']:''?>">
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <table class="nopadding" cellpadding="0" cellspacing="4" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <label>
                                <input type="radio" name="OG_SETTINGS_RESIZE[TYPE]" value="<?= BX_RESIZE_IMAGE_EXACT?>" <?=($arSettingResize['TYPE']==BX_RESIZE_IMAGE_EXACT)?'checked':''?>>
                                <?=Loc::getMessage('LABEL_SETTING_OG_BX_RESIZE_IMAGE_EXACT')?>
                            </label><br>
                            <label>
                                <input type="radio" name="OG_SETTINGS_RESIZE[TYPE]" value="<?= BX_RESIZE_IMAGE_PROPORTIONAL?>" <?=($arSettingResize['TYPE']==BX_RESIZE_IMAGE_PROPORTIONAL)?'checked':''?>>
                                <?=Loc::getMessage('LABEL_SETTING_OG_BX_RESIZE_IMAGE_PROPORTIONAL')?>
                            </label><br>
                            <label>
                                <input type="radio" name="OG_SETTINGS_RESIZE[TYPE]" value="<?= BX_RESIZE_IMAGE_PROPORTIONAL_ALT?>" <?=($arSettingResize['TYPE']==BX_RESIZE_IMAGE_PROPORTIONAL_ALT)?'checked':''?>>
