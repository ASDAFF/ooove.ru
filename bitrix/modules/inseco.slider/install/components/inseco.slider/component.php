...
$arParams["SLIDER_COUNT"] = intval($arParams["SLIDER_COUNT"]);
if($arParams["SLIDER_COUNT"]<=0)
	$arParams["SLIDER_COUNT"] = 5;
...
{
	$arNavParams = array(
		"nPageSize" => $arParams["SLIDER_COUNT"],
...
{
	$arNavParams = array(
		"nTopCount" => $arParams["SLIDER_COUNT"],
		"bDescPageNumbering" => $arParams["PAGER_DESC_NUMBERING"],
	);
	$arNavigation = false;
}
