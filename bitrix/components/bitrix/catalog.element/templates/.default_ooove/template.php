...
<div class="col-md-4">
<div style="background:url('/include/amber_fon_flower_x.png') no-repeat bottom right;background-color:white;border-radius:7px;border:1px solid #cfcfcf;padding:10px;margin-right:10%; margin-left:10%">
<?
...
<div class="row">
<!--  class="bx_rb" class="item_info_section"  class="bx_item_description"-->
...
<?
	...
	{
		?><div class="amber_item_block"><? echo $arResult['DETAIL_TEXT']; ?></div><?
	}
?>
	</div>
<?
