...
<?endif?>
	...
	array(
		...
		"REPLACE" => array(
			...
			"fields" => array(
				0 => rtrim(GetMessage("AUTH_NAME"),":"),
				1 => rtrim(GetMessage("AUTH_LAST_NAME"),":"),
				2 => rtrim(GetMessage("AUTH_LOGIN_MIN"),":"),
				3 => rtrim(GetMessage("AUTH_PASSWORD_REQ"),":"),
				4 => rtrim(GetMessage("AUTH_EMAIL"),":"),
			),
		),
