...
?>
	...
	<div class="item_current_price" id="<? echo $arItemIDs['PRICE']; ?>"><? echo $arResult['MIN_PRICE']['VALUE']-$arResult['MIN_PRICE']['PRINT_DISCOUNT_DIFF']; ?><? echo $arResult['MIN_PRICE']['CURRENCY']; ?></div>
	...
	<p>* цены актуальны только для Екатеринбурга. Цены в других регионах уточняйте у менеджера.</p>
</div>
<?
...
if ('' != $arResult['PREVIEW_TEXT'])
{
	...
	{
?>
<div class="item_info_section item_info_section_text">
...
{
?>
	<div class="item_buttons vam btnbigbasket">
		<span class="item_buttons_counter_block">
			<a href="javascript:void(0);" class="<? echo $buyBtnClass; ?>" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><? echo $buyBtnMessage; ?></a>
<?
	if ('Y' == $arParams['DISPLAY_COMPARE'])
