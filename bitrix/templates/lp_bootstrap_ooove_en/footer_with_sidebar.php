...
<?if($APPLICATION->GetCurPage() == "/"):?>
			<div class="row" style="background:#9a3120;color:#fff;padding:40px;min-height:400px;">
				<div class="col-md-6" style="padding-top:80px;font-size:300%;text-align:center;">ЗАДАЙТЕ СВОЙ<BR>ВОПРОС<BR><span style="font-size:30%">ЗАПОЛНИТЕ ФОРМУ И МЫ ПЕРЕЗВОНИМ ВАМ</span></div>
				<div class="col-md-6">
<?$APPLICATION->IncludeComponent(
