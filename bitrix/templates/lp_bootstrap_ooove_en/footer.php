			...
			<div class="row action" id="callback">
				<div class="col-md-6 action_block1">Please, ask<br><span style="font-size:160%">your question</span><br><br><span style="font-size:40%;">and we will answer<br>it within the next few days</span></div>
				<div class="col-md-6">
 <?$APPLICATION->IncludeComponent("kreattika:forms.feedback", "ooove_feedback_en", Array(
	"AJAX_MODE" => "Y",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
		"AJAX_OPTION_HISTORY" => "N",	// Включить эмуляцию навигации браузера
		"AJAX_OPTION_JUMP" => "N",	// Включить прокрутку к началу компонента
		"AJAX_OPTION_STYLE" => "Y",	// Включить подгрузку стилей
		"CHECK_FIELD_EMAIL" => "Y",	// Проверять заполнение поля Email
		"CHECK_FIELD_NAME" => "Y",	// Проверять заполнение поля Имя
		"CHECK_FIELD_PHONE" => "Y",	// Проверять заполнение поля Телефон
		"CHECK_FIELD_TEXT" => "N",	// Проверять заполнение поля Текст сообщения
		"COMPOSITE_FRAME_MODE" => "A",	// Голосование шаблона компонента по умолчанию
		"COMPOSITE_FRAME_TYPE" => "AUTO",	// Содержимое компонента
		"EMAIL_TO" => "sale@ooove.ru",	// E-mail, на который будет отправлено письмо
		"EVENT_MESSAGE_ID" => array(	// Почтовые шаблоны для отправки письма
			0 => "51",
		),
		"FIELD_EMAIL_TITLE" => "",	// Заголовок поля
		"FIELD_NAME_TITLE" => "Name",	// Заголовок поля
		"FIELD_PHONE_TITLE" => "",	// Заголовок поля
		"FIELD_TEXT_TITLE" => "",	// Заголовок поля
		"OK_TEXT" => "Thank you, we will answer it within the next few days",	// Сообщение, выводимое пользователю после отправки
		"SUBMIT_TITLE" => "Send",	// Текст на кнопке отправления сообщения
		"USE_CAPTCHA" => "Y",	// Использовать защиту от автоматических сообщений (CAPTCHA) для неавторизованных пользователей
		"USE_FIELD_EMAIL" => "Y",	// Отображать поле Email
		"USE_FIELD_NAME" => "Y",	// Отображать поле Имя
		"USE_FIELD_PHONE" => "Y",	// Отображать поле Телефон
		"USE_FIELD_TEXT" => "Y",	// Отображать поле текст сообщения
...
<h2>Examples of our products</h2>
 <?$APPLICATION->IncludeComponent(
