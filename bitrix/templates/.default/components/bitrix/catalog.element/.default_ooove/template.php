...
<div class="col-md-4">
<div style="background:url('/include/fon_gear_ooove_x.png') no-repeat bottom right;background-color:white;border-radius:7px;border:1px solid #cfcfcf;padding:10px;margin-right:10%; margin-left:10%">
<?
