...
?>
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div class="bx_catalog_item_controls_blocktwo">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium" href="javascript:void(0)" rel="nofollow"><span></span><?
		...
		{
			?><div class="bx_catalog_item_controls_blockone"><a href="<? echo $arItem['DETAIL_PAGE_URL'];?>"><span class="bx_notavailable">Заказать</span></a></div><?
