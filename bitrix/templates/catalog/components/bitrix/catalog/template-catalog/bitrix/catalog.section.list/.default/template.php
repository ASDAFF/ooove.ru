...
?><div class="catalog-cars-list clearfix"><?
		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<?if ($arSection["DEPTH_LEVEL"]  == 2 ){ ?>
					<div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="item">
					   <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="img-item" title="<? echo $arSection['PICTURE']['TITLE'];?>"><img src="<? echo $arSection['PICTURE']['SRC']; ?>"/></a>
					
						<?if ('Y' != $arParams['HIDE_SECTION_NAME']){?>
							<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="name-item"><? echo $arSection['NAME']; ?></a>
						<?}?>
					</div>
				<?} else{?>
					<div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="item-text">
						<?if ('Y' != $arParams['HIDE_SECTION_NAME']){?>
							<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="name-item"><? echo $arSection['NAME']; ?></a>
						<?}?>
					</div>
